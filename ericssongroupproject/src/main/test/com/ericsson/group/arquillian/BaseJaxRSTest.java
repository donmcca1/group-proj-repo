...
public class BaseJaxRSTest {
    ...
    public void query9()throws Exception{
        ...
        Assert.assertEquals("[[\"test mcc country\",\"test mnc operator\",1,1]]", responseObj.getEntity());
    }
    ...
    public void autocomplete_query1()throws Exception{
        ...
        request.queryParameter( "term",344930000000011L);

        ClientResponse<String> responseObj = request.get(String.class);

        Assert.assertEquals(344930000000011L,344930000000011L);
    }
    ...
    public void autocomplete_query2()throws Exception{
        ...
        Assert.assertEquals("test ue model","test ue model");
    }
